...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PF9     ------> ADC3_IN7
    */
    GPIO_InitStruct.Pin = RFUNIT_ALC_Pin|SWR_FORW_Pin|SWR_BACKW_Pin|RFUNIT_THERM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PF9     ------> ADC3_IN7
    */
    HAL_GPIO_DeInit(GPIOF, RFUNIT_ALC_Pin|SWR_FORW_Pin|SWR_BACKW_Pin|RFUNIT_THERM_Pin);
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOJ, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3
                          |GPIO_PIN_5|GPIO_PIN_10|GPIO_PIN_13|GPIO_PIN_14);

    HAL_GPIO_DeInit(GPIOK, GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_4|GPIO_PIN_5
                          |GPIO_PIN_6);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = TIM2_CH4_TFT_LEDCTRL_DIGITAL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(TIM2_CH4_TFT_LEDCTRL_DIGITAL_GPIO_Port, &GPIO_InitStruct);
...
/* SAI2 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOI, GPIO_PIN_5|GPIO_PIN_7);
